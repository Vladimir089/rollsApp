...
class StatView: UIView {
    ...
    private func createInterface() {
        ...
        let nameLabel = generateLaels(text: "\(nameCafe)", fonc: .systemFont(ofSize: 28, weight: .semibold), textColor: .TC)
        ...
        winnerLabel = generateLaels(text: "🏆 - 1 место в Учкекене", fonc: .systemFont(ofSize: 14, weight: .regular), textColor: .TC)
        ...
        let centerView = createView(color: .ratingCenterView, cornerRadius: 10)
        ...
        let labelCash = generateLaels(text: "Касса", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        let perevodlCash = generateLaels(text: "Переводы", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        let courerCash = generateLaels(text: "Курьеру", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        let summCash = generateLaels(text: "Итого", fonc: .systemFont(ofSize: 18, weight: .semibold), textColor: .TC)
        ...
        labelCashh = generateLaels(text: "0 ₽", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        labelPerevod = generateLaels(text: "0 ₽", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        labelCourier = generateLaels(text: "0 ₽", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
        ...
        labelSumm = generateLaels(text: "0 ₽", fonc: .systemFont(ofSize: 18, weight: .regular), textColor: .TC)
